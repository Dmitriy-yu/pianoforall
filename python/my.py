#c:\Users\Долгорукий\Desktop\Визитка\python\my.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
def send_mail(subject, content):
    ...
    sender_email = "Dmitriy_yu_88@mail.ru"
    receiver_email = "Dmitriy_yu_88@mail.ru"
    password = "D3000"
...
class MyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.end_headers()
        try:
            index_path = './Визитка/index.html'# os.path.join(APP_DIR, 'index.html')
...
if __name__ == '__main__':
    # send_mail("Сайт 'СЧ': " + "Тема",
    #                       "Сообщение отправлено с сайта от %s (email: %s)\r\n\r\n%s" % ("Егор", "erer@mail,ru", "Текст"))
